...
const MapSide: React.FC<IMapSideProps> = ({setMap, markers, markerInfo, setMarkerInfo, onClickChangePoint, onClickSearchDirection, departure, arrive }) => {
                            ...
                            <StyledMapCard>
                                <Card.Body >
                                    ...
                                    <Card.Link href={`https://map.kakao.com/link/to/${markerInfo.place_name},${markerInfo.y},${markerInfo.x}`} target={"_blank"} >
                                        <StyledDirectionBtn variant="success" onClick={ () => onClickSearchDirection({arrive : arrive, departure : departure}, {lat : markerInfo.y, lng : markerInfo.x})} >
                                            길찾기
                                        </StyledDirectionBtn>
                                    </Card.Link>
                                </Card.Body> 
